...
Button(root, text="Generate", command=onclick, width=10).grid(row=3, column=0, sticky="e", padx=10, pady=10)
Button(root, text="Copy", command=copyclip, width=10).grid(row=3, column=1, sticky="w", padx=10, pady=10)
